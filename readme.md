...
* `manifest.json`: The entry point. Permissions: `activeTab`, `scripting`, `tabs`, `storage`.
* `background.js`: The central nervous system. Routes messages between the isolated worlds of the Agent and the Target.
...
* **Speed:** The Diff Engine debounces updates by 1000ms to prevent flooding the context window during rapid typing or animations.
